...
export const BuyMeACoffee = () => {
  ...
  const handleSignTransaction = (evt: any) => {
    ...
    clickRef.send(transaction.toJSON() as object, senderPk);
  };
        ...
        <ol>
          <li>
            ...
            <p>
              ...
              <Link color={'inherit'} href={'https://casper-ecosystem.github.io/casper-js-sdk/'}>SDK documentation</Link> for more detailed usage and examples.
            </p>
          </li>
